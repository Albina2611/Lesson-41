...
// const clock  = document.querySelector('.sec')
...
//     }, 1000);
//     }
//     btn.removeEventListener('click', timerTime)
// btn.addEventListener('click', timerTime)
...
//     clock.textContent = `${day}/${month}/${year}  ${hour}:${min}:${sec}`
//     }, 0);
